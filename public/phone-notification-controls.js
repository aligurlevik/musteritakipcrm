(function(){
  ...
  function init(){
    ...
    const test=document.createElement('button');test.id='mobileNotifyTest';test.type='button';test.textContent='🔊 ANDROID BİLDİRİM TESTİ';test.onclick=testAlarm;status.insertAdjacentElement('afterend',test);
    const pair=document.createElement('button');pair.id='nativeAlarmPair';pair.type='button';pair.textContent='📱 GERÇEK ALARM UYGULAMASINI BAĞLA';pair.onclick=pairNativeAlarm;test.insertAdjacentElement('afterend',pair);update();
  }
