(function(){
  ...
  function init(){
    ...
    const test=document.createElement('button');test.id='mobileNotifyTest';test.type='button';test.textContent='🔔 Sesli Bildirimi Dene';test.onclick=testAlarm;status.insertAdjacentElement('afterend',test);update();
  }
