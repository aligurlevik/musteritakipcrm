...
async function ensureSchema(env) {
  ...
  await env.DB.prepare(`CREATE TABLE IF NOT EXISTS graphic_jobs (
    ...
    status TEXT DEFAULT 'Beklemede', note TEXT DEFAULT '', price REAL DEFAULT 0, created_by TEXT DEFAULT '', completed_by TEXT DEFAULT '', created_at TEXT DEFAULT CURRENT_TIMESTAMP,
