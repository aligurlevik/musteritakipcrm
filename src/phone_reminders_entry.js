...
export default{
  async fetch(request,env,ctx){
    ...
    if(['/agenda-sw.js','/agenda.webmanifest','/crm.webmanifest','/agenda-icon-192.png','/agenda-icon-512.png','/phone-reminders.js','/phone-notification-controls.js'].includes(path)){
