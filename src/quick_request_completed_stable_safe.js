...
function ensure(){
 ...
 if(!document.getElementById('quickRequestCompletedStable')){var w=document.createElement('div');w.id='quickRequestCompletedStable';w.innerHTML='<h3>BUGÜN TAMAMLANANLAR</h3><div class="qrcs-list"><div class="qrcs-empty">Bugün tamamlanan talep yok.</div></div>';legacy.insertAdjacentElement('afterend',w)}
